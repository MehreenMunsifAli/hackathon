            ...
            <div className="hidden md:col-span-3 md:col-start-10 row-start-5 w-[85%] md:flex justify-center my-1">
                <div>
                    ...
                    <div className="space-y-4">
                        <LatestProductsCard ComponentWidth={170} ImagePath="/assets/images/shop/latest_products_card/Vector.svg" ImageWidth={60} ImageText="Food" DishName="Pizza" Price={35} />
                        <LatestProductsCard ComponentWidth={170} ImagePath="/assets/images/shop/latest_products_card/Vector.svg" ImageWidth={60} ImageText="Food" DishName="Cupchake" Price={35} />
                        <LatestProductsCard ComponentWidth={170} ImagePath="/assets/images/shop/latest_products_card/Vector.svg" ImageWidth={60} ImageText="Food" DishName="Cookies" Price={35} />
                        <LatestProductsCard ComponentWidth={170} ImagePath="/assets/images/shop/latest_products_card/Vector.svg" ImageWidth={60} ImageText="Food" DishName="Burger" Price={35} />
                    </div>
                </div>   
            </div>
