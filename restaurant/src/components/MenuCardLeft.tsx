...
export default function MenuCardLeft({ImageSrc, ImageText, MealType, Dish1, DishDes1, DishCal1, DishPrice1, Dish2, DishDes2, DishCal2, DishPrice2, Dish3, DishDes3, DishCal3, DishPrice3, Dish4, DishDes4, DishCal4, DishPrice4}: MenuCardType) {
    return(
        <>
            <div className="container max-w-screen-lg mx-auto grid grid-cols-5 md:grid-cols-12 grid-rows-[100px_100px_100px_100px_100px_100px_100px_100px_100px_100px] md:grid-rows-[100px_100px_100px_100px_100px] text-white ">
                ...
                {/* Starter Menu */}
                <div className="col-span-4 row-start-6 md:col-span-4 md:col-start-6 md:row-start-1 flex flex-col justify-center md:justify-start">
                    <PiCoffeeBold className="text-[#FF9F0D]"/>
                    <h1 className="text-h5 lg:text-h3 text-[#333333] font-bold ">{MealType}</h1>
                </div>
                {/* Starter Menu Row 2 */}
                <div className="col-span-4 row-start-7 md:col-span-4 md:col-start-6 md:row-start-2">
                ...
                {/* Starter Menu Row 3 */}
                <div className="col-span-4 row-start-8 md:col-span-4 md:col-start-6 md:row-start-3">
                ...
                {/* Starter Menu Row 4 */}
                <div className="col-span-4 row-start-9 md:col-span-4 md:col-start-6 md:row-start-4">
                ...
                {/* Starter Menu Row 5 */}
                <div className="col-span-4 row-start-10 md:col-span-4 md:col-start-6 md:row-start-5">
                ...
                {/* First Price Row 2 */}
                <div className="col-end-6 row-start-7 md:col-end-13 md:row-start-2 flex justify-end">
                    <p className="text-[#FF9F0D]">{DishPrice1}$</p>
                </div>
                {/* Second Price Row 3 */}
                <div className="col-end-6 row-start-8 md:col-end-13 md:row-start-3 flex justify-end">
                    <p className="text-[#FF9F0D]">{DishPrice2}$</p>
                </div>
                {/* Third Price Row 4 */}
                <div className="col-end-6 row-start-9 md:col-end-13 md:row-start-4 flex justify-end">
                    <p className="text-[#FF9F0D]">{DishPrice3}$</p>
                </div>
                {/* Fourth Price Row 5 */}
                <div className="col-end-6 row-start-10 md:col-end-13 md:row-start-5 flex justify-end">
